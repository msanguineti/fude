/**
 * 文字装飾コード番号 - The character OrnamentCode to apply
 *
...
/** @constant ideogramDU ideogram double underline or  double line on the right side*/
...
/** @constant ideogramDO ideogram double overline or  double line on the left side*/
